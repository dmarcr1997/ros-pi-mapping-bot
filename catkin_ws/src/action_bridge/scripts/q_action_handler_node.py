...
class QActionHandler:
    def __init__(self):
        ...
        self.motor_pub = rospy.Publisher("/motor_commands", String, queue_size=10) # setup publisher to motor_control node to send commands to motor controller
...
if __name__ == "__main__": # File entry point
    try:
